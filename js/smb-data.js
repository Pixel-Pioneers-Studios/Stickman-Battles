...
const ARENAS = {
  ...
  megacity: {
    ...
    platforms: [
      ...
      // Lower tier — evenly spread across -800..2600
      { x:-820, y:450, w:220, h:18 },
      { x:-450, y:430, w:180, h:18 },
      { x:-120, y:460, w:200, h:18 },
      { x: 220, y:440, w:190, h:18 },
      { x: 560, y:430, w:200, h:18 },
      { x: 890, y:450, w:180, h:18 },
      { x:1220, y:440, w:190, h:18 },
      { x:1550, y:430, w:200, h:18 },
      { x:1880, y:450, w:180, h:18 },
      { x:2210, y:440, w:190, h:18 },
      { x:2530, y:460, w:200, h:18 },
      // Mid tier
      { x:-700, y:340, w:180, h:18 },
      { x:-380, y:310, w:200, h:18 },
      { x: -50, y:350, w:180, h:18 },
      { x: 300, y:320, w:200, h:18 },
      { x: 640, y:340, w:180, h:18 },
      { x: 970, y:310, w:200, h:18 },
      { x:1300, y:350, w:180, h:18 },
      { x:1630, y:320, w:200, h:18 },
      { x:1960, y:340, w:180, h:18 },
      { x:2290, y:310, w:200, h:18 },
      { x:2580, y:350, w:180, h:18 },
      // Upper tier
      { x:-600, y:210, w:180, h:18 },
      { x:-260, y:190, w:200, h:18 },
      { x:  80, y:220, w:180, h:18 },
      { x: 420, y:190, w:200, h:18 },
      { x: 760, y:210, w:180, h:18 },
      { x:1090, y:180, w:200, h:18 },
      { x:1420, y:210, w:180, h:18 },
      { x:1750, y:190, w:200, h:18 },
      { x:2080, y:220, w:180, h:18 },
      { x:2400, y:190, w:200, h:18 },
      // Top tier
      { x:-480, y:100, w:200, h:18 },
      { x:-100, y: 80, w:180, h:18 },
      { x: 260, y:100, w:200, h:18 },
      { x: 640, y: 80, w:180, h:18 },
      { x:1020, y:100, w:200, h:18 },
      { x:1400, y: 80, w:180, h:18 },
      { x:1780, y:100, w:200, h:18 },
      { x:2160, y: 80, w:180, h:18 },
      { x:2500, y:100, w:200, h:18 },
    ]
  },
  warpzone: {
