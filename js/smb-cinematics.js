...
function _makeTFEntryCinematic(tf) {
  return cinScript({
    ...
    steps: [
      ...
      { at: 1.0, dialogue: 'You pushed past the limit I set.', dialogueDur: 170 },
      ...
      { at: 1.9, dialogue: 'This is what I keep in reserve.', dialogueDur: 200 },
...
function _makeTFReality50Cinematic(tf) {
  return cinScript({
    ...
    steps: [
      ...
      { at: 0.8, dialogue: 'Reality is a setting.', dialogueDur: 140 },
      ...
      { at: 1.5, dialogue: 'I adjusted it.', dialogueDur: 180 },
...
function _makeTFDesp15Cinematic(tf) {
  return cinScript({
    ...
    steps: [
      ...
      { at: 1.4, dialogue: 'You want to end it?',     dialogueDur: 120 },
      { at: 2.0, dialogue: 'Then we end it together.', dialogueDur: 220 },
