...
const ARENAS = {
  grass: {
    ...
    platforms: [
      ...
      { x: 370, y: 195, w: 160, h: 18 }, // centre top
      { x: 175, y: 275, w: 165, h: 18 }, // left mid
      { x: 560, y: 275, w: 165, h: 18 }, // right mid
      { x:  30, y: 158, w: 115, h: 16 }, // far-left high
      { x: 755, y: 158, w: 115, h: 16 }, // far-right high
    ]
  },
  lava: {
    sky:            ['#1a0000', '#3d0800'],
  ...
  space: {
    ...
    platforms: [
      ...
      { x: 355, y: 175, w: 190, h: 15 }, // centre top
      { x: 145, y: 258, w: 165, h: 15 }, // left mid
      { x: 590, y: 258, w: 165, h: 15 }, // right mid
      { x:  22, y: 165, w: 105, h: 15 }, // far-left
      { x: 773, y: 165, w: 105, h: 15 }, // far-right
    ]
  },
  city: {
    sky:         ['#060614', '#121228'],
    ...
    platforms: [
      ...
      { x:  52, y: 265, w: 132, h: 15 }, // left mid
      { x: 372, y: 248, w: 156, h: 15 }, // centre mid
      { x: 716, y: 265, w: 132, h: 15 }, // right mid
      { x: 198, y: 162, w: 122, h: 15 }, // left high
      { x: 580, y: 162, w: 122, h: 15 }, // right high
    ]
  },
  void: {
    sky:         ['#000000', '#050505'],
  ...
  forest: {
    ...
    platforms: [
      ...
      { x: 340, y: 195, w: 220, h: 18 },
      { x: 120, y: 275, w: 145, h: 18 },
      { x: 635, y: 275, w: 145, h: 18 },
      { x:  18, y: 140, w: 110, h: 16 },
      { x: 772, y: 140, w: 110, h: 16 },
      { x: 375, y: 100, w: 150, h: 16 },
    ]
  },
  ice: {
    sky:         ['#99c8e8', '#cce8f8'],
    ...
    platforms: [
      ...
      { x: 310, y: 210, w: 280, h: 16 },
      { x:  70, y: 292, w: 170, h: 16 },
      { x: 660, y: 292, w: 170, h: 16 },
      { x: 185, y: 148, w: 130, h: 16 },
      { x: 585, y: 148, w: 130, h: 16 },
    ]
  },
  ruins: {
    sky:         ['#1f1008', '#3a2418'],
